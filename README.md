...
## Цель
1) Записать музыкальный инструмент в `*.wav` (желательно **моно**).  
2) Построить **спектрограмму** с помощью оконного БПФ (**STFT**) с окном **Ханна** и сохранить в файл (частоты — **логарифмическая шкала**).  
3) Оценить шум, попробовать **вычесть шум** и сравнить спектрограммы до/после. Восстановить аудио и сравнить с оригиналом.  
4) Найти моменты времени с максимальной энергией в окрестности при **Δt = 0.1 с** и **Δf = 40–50 Гц**.
